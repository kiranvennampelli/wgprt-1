...
# Second widget: Additional section in the second column
#with col2:
    #st.subheader('Additional Information')
    #st.text('This section can be used for additional functionality or information.')
   # additional_input = st.text_input('Enter additional details here:')
    #if st.button('Submit Additional Details'):
       # if additional_input:
            #st.success(f'You entered: {additional_input}')
        #else:
